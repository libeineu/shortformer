...
@register_model("numerical_transformer_v7_lm", dataclass=TransformerLanguageModelConfig)
...
@register_model_architecture("numerical_transformer_v7_lm", "numerical_transformer_v7_lm")
...
@register_model_architecture("numerical_transformer_v7_lm", "numerical_transformer_v7_lm_big")
def numerical_transformer_v7_lm_big(args):
...
@register_model_architecture("numerical_transformer_v7_lm", "numerical_transformer_v7_lm_baevski_wiki103")
def numerical_transformer_v7_lm_baevski_wiki103(args):
    ...
    numerical_transformer_v7_lm_big(args)


@register_model_architecture("numerical_transformer_v7_lm", "numerical_transformer_v7_lm_gbw")
@register_model_architecture("numerical_transformer_v7_lm", "numerical_transformer_v7_lm_baevski_gbw")
def numerical_transformer_v7_lm_baevski_gbw(args):
    args.decoder_embed_dim = getattr(args, "decoder_embed_dim", 512)
    args.dropout = getattr(args, "dropout", 0.1)
    args.attention_dropout = getattr(args, "attention_dropout", 0.1)
    args.no_decoder_final_norm = getattr(args, "no_decoder_final_norm", True)
...
@register_model_architecture("numerical_transformer_v7_lm", "numerical_transformer_v7_lm_gpt")
def numerical_transformer_v7_lm_gpt(args):
...
@register_model_architecture("numerical_transformer_v7_lm", "numerical_transformer_v7_lm_gpt2_small")
def numerical_transformer_v7_lm_gpt2_small(args):
    args.decoder_embed_dim = getattr(args, "decoder_embed_dim", 1024)
    args.decoder_ffn_embed_dim = getattr(args, "decoder_ffn_embed_dim", 4096)
...
@register_model_architecture("numerical_transformer_v7_lm", "numerical_transformer_v7_lm_gpt2_medium")
def numerical_transformer_v7_lm_gpt2_medium(args):
...
@register_model_architecture("numerical_transformer_v7_lm", "numerical_transformer_v7_lm_gpt2_big")
def numerical_transformer_v7_lm_gpt2_big(args):
