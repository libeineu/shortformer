...
data=wiki
tag=pre_cor_v2_gated_shorformer_Layer8_stage1_v2_rknorm

if [ $data == "wiki" ]; then
        arch=numerical_transformer_v2_lm_wiki103
        max_tokens=9216
...
cp ./ITP_stage1.sh $save_dir/train_lm.sh
